...
from app.models.market import (
    QuoteResponse, OptionChainResponse, HistoricalDataResponse,
...
from app.core.exceptions import RateLimitError, MarketDataError
...
async def get_market_status(response: Response):
    ...
    status = MarketStatus(
        ...
        rate_limit_reset=datetime.fromtimestamp(rate_limiter.get_reset_time()).isoformat(),
