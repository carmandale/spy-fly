...
from app.services.sentiment_calculator import (
    score_vix, score_futures, score_rsi, score_ma50, 
    score_bollinger, calculate_rsi, calculate_bollinger_position
)
...
class TestTechnicalIndicators:
    ...
    def sample_prices(self):
        ...
        np.random.seed(42)
        prices = pd.Series([560.0 + i * 0.3 + np.random.uniform(-2, 2) for i in range(50)])
        return prices
