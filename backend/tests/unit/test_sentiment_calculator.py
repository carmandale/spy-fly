...
class TestSentimentCalculator:
    ...
    @pytest.mark.asyncio
    async def test_bullish_sentiment(self, calculator, mock_market_service, mock_historical_data):
        ...
        with patch.object(calculator, '_get_vix_data', return_value={"value": 14.5}):
            with patch.object(calculator, '_get_futures_data', return_value={
                "current": 5680.0,
    ...
    @pytest.mark.asyncio
    async def test_bearish_sentiment(self, calculator, mock_market_service, mock_historical_data):
    ...
    @pytest.mark.asyncio
    async def test_edge_case_sentiment(self, calculator, mock_market_service, mock_historical_data):
    ...
    @pytest.mark.asyncio
    async def test_cache_hit(self, calculator, mock_market_service, mock_historical_data):
    ...
    @pytest.mark.asyncio
    async def test_force_refresh(self, calculator, mock_market_service, mock_historical_data):
        mock_market_service.get_historical_data.return_value = Mock(
            model_dump=lambda: mock_historical_data
        )
    ...
    @pytest.mark.asyncio
    async def test_technical_status_evaluation(self, calculator, mock_market_service, mock_historical_data):
        mock_market_service.get_historical_data.return_value = Mock(
            model_dump=lambda: mock_historical_data
        )
