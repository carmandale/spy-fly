...
class TestMarketHoursTimezone:
    ...
    def test_market_hours_from_different_timezones(self, service):
        ...
        test_cases = [
            ...
            {
                "server_time": datetime(
                    2025, 7, 29, 6, 0, 0, tzinfo=ZoneInfo("America/Los_Angeles")
                ),  # 9:00 AM ET
                "expected": "pre-market",
            },
            ...
            {
                "server_time": datetime(
                    2025, 7, 29, 16, 30, 0, tzinfo=ZoneInfo("America/Chicago")
                ),  # 5:30 PM ET
            ...
            {
                "server_time": datetime(
                    2025, 7, 29, 16, 0, 0, tzinfo=ZoneInfo("Europe/London")
                ),  # 11:00 AM ET
                "expected": "regular",
            },
        ]
        ...
        for case in test_cases:
            with patch("app.services.market_service.datetime") as mock_datetime:
                ...
                ), f"Failed for server time {case['server_time']}"
    ...
    def test_market_hours_edge_cases(self, service):
        ...
        edge_cases = [
            ...
            {
                "time": datetime(
                    2025, 7, 29, 9, 30, 0, tzinfo=ZoneInfo("America/New_York")
                ),
                "expected": "regular",
            },
            ...
            {
                "time": datetime(
                    2025, 7, 29, 9, 29, 59, tzinfo=ZoneInfo("America/New_York")
                ),
                "expected": "pre-market",
            },
            ...
            {
                "time": datetime(
                    2025, 7, 29, 16, 0, 0, tzinfo=ZoneInfo("America/New_York")
                ),
                "expected": "regular",
            },
            ...
            {
                "time": datetime(
                    2025, 7, 29, 16, 0, 1, tzinfo=ZoneInfo("America/New_York")
                ),
                "expected": "after-hours",
            },
        ]
    ...
    def test_market_hours_holidays(self, service):
        ...
        christmas = datetime(
            2025, 12, 25, 10, 0, 0, tzinfo=ZoneInfo("America/New_York")
        )
