...
def upgrade() -> None:
    ...
    op.create_index('idx_log_timestamp', 'api_requests_log', ['timestamp'], unique=False)
    op.create_index('idx_status_code', 'api_requests_log', ['status_code'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('symbol', 'date', 'timeframe', name='uq_symbol_date_timeframe')
    )
    ...
    op.create_index('idx_option_timestamp', 'option_contracts', ['timestamp'], unique=False)
    op.create_index('idx_strike_type', 'option_contracts', ['strike', 'option_type'], unique=False)
    op.create_index('idx_underlying_expiration', 'option_contracts', ['underlying', 'expiration_date'], unique=False)
    op.create_table('spy_quotes',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('symbol', sa.String(length=10), nullable=False),
    ...
    op.create_index('idx_symbol_timestamp', 'spy_quotes', ['symbol', 'timestamp'], unique=False)
